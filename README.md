...
[![GitHub commits since tagged version](https://img.shields.io/github/commits-since/webAIdev/facebook-scraper/v0.2.59)](https://github.com/webAIdev/facebook-scraper/commits/)
...
```sh
pip install git+https://github.com/webAIdev/facebook-scraper.git
```
